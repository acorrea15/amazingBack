...
router.post('/', async(req, res)=> {
  try {
    ...
    const appointmentSchedule = await AppointmentSchedule.create({appointmentDay, appointmentTimes});   
...
router.patch('/:id', async(req, res)=> {
  ...
  try {
    ...
    const appointmentSchedule = await AppointmentSchedule.findByIdAndUpdate(id, {isEnabled, appointmentTimes});
